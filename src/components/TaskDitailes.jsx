...
export default function TaskDitailes(props) {

  return (
    <div style={{width:'18%',height:'6cm',border:'3px solid beige',borderRadius:'15px',marginLeft:'40%',marginTop:'0.6cm'}}>
...
<Button style={{fontFamily:'Courier',backgroundColor:'beige',height:'0.8cm'}} onClick={props.deleteTask} variant="contained"><h3 style={{color: 'rgb(203, 68, 11)'}}>Finish</h3></Button>
    </div>
  )
}
